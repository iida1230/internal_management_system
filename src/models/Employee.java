...
@NamedQueries({
    ...
    @NamedQuery(name = "getAllDepartmentEmployees",query = "SELECT e FROM Employee AS e WHERE EXISTS(SELECT d FROM Department AS d WHERE e=d.employee AND d.departmentName.id=:dn )"),
    @NamedQuery(name = "getApproval2",query = "SELECT e FROM Employee AS e WHERE e.approval=2 ORDER BY e.id DESC"),
    @NamedQuery(name = "getApproval3",query = "SELECT e FROM Employee AS e WHERE e.approval=3 ORDER BY e.id DESC"),
